...
const Home = () => {
  ...
  return (
    <>
      <MetaTags
        title="Commune ai 🗺 Travel Advisor"
        description="Fully-responsive travel Assistant and weather checking app built by combining Google Maps API, Travel Advisor API and WeatherAPI.com. Built using Next.js and TypeScript, this app can be used to search for places, fetch restaurant, hotels and attractions based on current or allocated location."
        // url="https://github.com/LuxeCover/search-app"
